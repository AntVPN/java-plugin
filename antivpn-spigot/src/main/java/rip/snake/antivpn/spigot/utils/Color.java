...
public class Color {
    ...
    public static String colorize(String text) {
        ...
        // 2. Serialize to Bukkit legacy format (translates MiniMessage colors like <red> into §c)
        // This is what allows old 1.8 servers to render modern MiniMessage configurations!
